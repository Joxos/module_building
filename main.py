...
final_results = []
repeater_num, fox_num, acceptor_num, cheater_num, detector_num = 5, 5, 25, 5, 5
for round in range(3):
    settings = GameSettings(
        reward_matrix=reward_configs[round],
        times=10,
        reset_points=True,
        evolution_strategy=EvolutionStrategy.OBSOLETE_LAST,
        evolution_num=5,
...
draw_rounds_impact([reward.title for reward in reward_configs], final_results)
